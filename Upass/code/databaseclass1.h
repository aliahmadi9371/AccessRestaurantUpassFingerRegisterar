#ifndef DATABASECLASS1_H
#define DATABASECLASS1_H
...
class DatabaseClass1 : public QObject
{
    Q_OBJECT
public:
    explicit DatabaseClass1(QObject *parent = 0);
    bool    b_db_isOpen;
    void func_db_OpenDb();
private:
    //params
    ...
    void func_db_checkTag1(QString tagnumber);
...
signals:
    ...
    void signal_db_changeProgStatus1(bool proc);

    void signal_db_success1();

    void signal_db_databaseConnection1(bool status);
...
private slots:
    ...
    void slot_db_GetNew_EPC_Data_port1(QString epcData);
